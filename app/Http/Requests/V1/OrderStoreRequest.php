...
class OrderStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'gross_amount'         => ['nullable', 'numeric', 'between:0.01,999999.99999'],
            'net_amount'           => ['nullable', 'numeric', 'between:0.01,999999.99999'],
            'global_discount'      => ['nullable', 'numeric', 'between:0.01,999999.99999'],
            'total_surcharge'      => ['nullable', 'numeric', 'between:0.01,999999.99999'],
            'total_freight'        => ['nullable', 'numeric', 'between:0.01,999999.99999'],
