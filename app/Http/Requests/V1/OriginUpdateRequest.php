...
class OriginUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($method == 'PUT') {
            return [
                'description'  => ['required', 'string', 'max:100', Rule::unique('colours')->ignore($this->id)],
            ...
            return [
                'description'  => ['sometimes', 'required', 'string', 'max:100', Rule::unique('colours')->ignore($this->id)],
