    ...
    public function rules(): array
    {
        ...
        if ($method == 'PUT') {
            ...
            return [
                ...
                'line_number'                 => ['sometimes', 'required', 'integer'],
                'origin_document_type'        => ['sometimes', 'required', 'string', 'max:1'],
                'origin_line_number'          => ['sometimes', 'required', 'integer'],
                'article_id'                  => ['sometimes', 'required', 'integer', 'exists:articles,id'],
                'warehouse_id'                => ['sometimes', 'required', 'integer', 'exists:warehouses,id'],
                'sub_total'                   => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'qty'                         => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'qty_secondary_unit'          => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'pending'                     => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'sale_unit'                   => ['sometimes', 'required', 'string', 'max:6'],
                'sale_price'                  => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'discounts'                   => ['sometimes', 'required', 'string', 'max:15'],
                'tax_type'                    => ['sometimes', 'required', 'string', 'max:1'],
                'net_line'                    => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'average_unit_cost'           => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'last_unit_cost'              => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'average_unit_cost_oc'        => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'last_unit_cost_oc'           => ['sometimes', 'required', 'numeric', 'between:0.99999,9999999.99999'],
                'pay_back_amount'             => ['nullable', 'numeric', 'between:0.99999,9999999.99999'],
                'pay_back_total'              => ['nullable', 'numeric', 'between:0.99999,9999999.99999'],
                'sale_price_oc'               => ['nullable', 'numeric', 'between:0.99999,9999999.99999'],
                'article_generic_description' => ['nullable', 'string', 'max:60'],
