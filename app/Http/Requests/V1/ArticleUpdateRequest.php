...
class ArticleUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'code'             => ['sometimes', 'required', 'string', 'max:30', Rule::unique('articles')->ignore($this->id)],
            'description'      => ['sometimes', 'required', 'string', 'max:100', Rule::unique('articles')->ignore($this->id)],
