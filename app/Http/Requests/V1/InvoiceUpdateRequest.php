...
class InvoiceUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($method == 'PUT') {
            return [
                ...
                'condition_payments_id'      => ['required', 'integer', 'exists:condition_payments,id'],
            ...
            return [
                ...
                'fiscal_number'              => ['sometimes', 'required', 'string', 'max:18'],
                'fiscal_number2'             => ['sometimes', 'required', 'string', 'max:18'],
                ...
                'condition_payments_id'      => ['sometimes', 'required', 'integer', 'exists:condition_payments,id'],
                'control_number'             => ['sometimes', 'required', 'integer'],
                'status'                     => ['sometimes', 'required', 'string', 'max:1'],
                'exchange_rate'              => ['sometimes', 'required', 'numeric', 'between:0.01,999.99999'],
                'description'                => ['nullable', 'string', 'max:60'],
                'balance'                    => ['sometimes', 'required', 'numeric', 'between:0.01,99999.99999'],
                'bill_date'                  => ['sometimes', 'required'],
                'due_date'                   => ['sometimes', 'required'],
                'comments'                   => ['nullable', 'string'],
                'delivery_address'           => ['nullable', 'string'],
                'gross_amount'               => ['sometimes', 'required', 'numeric', 'between:0.01,99999.99999'],
                'net_amount'                 => ['sometimes', 'required', 'numeric', 'between:0.01,99999.99999'],
                'global_discount_percentage' => ['nullable', 'string', 'max:15'],
                'global_discount_amount'     => ['nullable', 'numeric', 'between:0.01,999.99999'],
                'surcharge_percentage'       => ['nullable', 'string', 'max:15'],
                'surcharge_amount'           => ['nullable', 'numeric', 'between:0.01,99999.99999'],
        ...
        protected function prepareForValidation()
    {
        ...
        if (strlen($this->seller_id)) {
            $this->merge([ 'seller_id' => $this->seller_id, ]);
        }
