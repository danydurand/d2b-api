...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->foreignId('business_id')->constrained()->on('businesses');
            ...
            $table->foreignId('origin_id')->constrained()->on('origins');
            $table->foreignId('article_type_id')->constrained()->on('article_types');
            $table->foreignId('provider_id')->constrained()->on('providers');
